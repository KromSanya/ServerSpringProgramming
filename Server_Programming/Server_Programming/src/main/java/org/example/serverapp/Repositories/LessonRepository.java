...
import org.example.serverapp.Utils.rowMappers.LessonRowMapper;
...
public class LessonRepository {
    ...
    public long saveLesson(CreateOrUpdateLessonPojo pojo) {
        String sql = "insert into Lesson (date, time, teacherId, groupId, subjectId) values (?, ?, ?, ?, ?)";
    ...
    public void updateLesson(long id, CreateOrUpdateLessonPojo pojo) {
        jdbcTemplate.update(
                "update Lesson set date = ?, time = ?, teacherId = ?, groupId = ?, subjectId = ? where id = ?",
